...
function CaseStudy() {
  ...
  return (
    <div className="px-[10px] relative">
      <div className="max-w-[900px] laptop2:max-w-[1000px] laptop:h-[600px]  mx-[10px] tablet:mx-[50px] laptop:mx-auto mt-[120px] px-[30px] py-[10px] laptop:px-[88px]  text-[white] bg-gradient-to-r from-[#7060EF] to-[#1FBAEA] relative font-[manrope] rounded-[20px]">
        <h4
          data-aos="zoom-out"
        ...
        <div
          data-aos="zoom-out"
          className="relative w-[325px] h-[325px] tablet:w-[225px] tablet:h-[305px] midTablet:w-[275px] midTablet:h-[325px] laptop:w-[325px] laptop:h-[405px] mt-[40px] bigTablet:mt-[60px] mx-auto tablet:mx-[initial]"
        >
          <img
            src={manImage}
            alt="man"
        ...
        <img
          ...
          src={graph}
          alt="graph"
          className="absolute mobile:invisible tablet:visible top-[230px] right-[-30px] w-[300px] midTablet:w-[400px] laptop:top-[280px] laptop:w-[500px] laptop:h-[300px] object-contain"
        />
        {embedVideo && (
      ...
      <div className="font-[manrope] ">
        <h4
          // data-aos="zoom-in"
          className="max-w-[868px] mt-[120px] tablet:mt-[150px] mx-auto text-[20px] bigTablet:text-[24px] text-center px-[10px]"
        >
