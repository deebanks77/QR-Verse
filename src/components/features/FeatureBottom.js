...
function FeatureBottom(props) {
  const { phone } = props;
  return (
    <div className="max-w-[1166px] h-[500px] flex flex-col-reverse bigTablet:flex-row items-center justify-center gap-[100px] mx-auto mt-[200px] mobile2:mt-[270px] bigTablet:mt-[50px] desktop:mt-[148px]">
      <div
        data-aos="fade-right"
        className="font-[manrope] mt-[-20px] mobile2:mt-[-45px] bigTablet:mt-0 w-[290px] desktop:w-[450px] desktop:h-[469px]"
      >
